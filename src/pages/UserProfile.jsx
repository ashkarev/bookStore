...
const UserProfile = () => {
  ...
  return (
    <div>
          ...
          <div className="flex gap-30 px-30 mt-10">
            <div className="flex flex-col gap-4">
              <input
                ...
                type="text"
                placeholder="title"
                className="w-100 text-black bg-white rounded-2xl p-1"
              />
              <input
                onChange={(e) =>
            ...
            <div className="flex flex-col gap-4">
                  ...
                  {previwImages.length <= 2 && (
                    <label htmlFor="plus">
                      ...
                      <img
                        ...
                        src="https://media.istockphoto.com/id/1365197728/vector/add-plus-medical-cross-round-button-3d-vector-icon-cartoon-minimal-style.jpg?s=612x612&w=0&k=20&c=A-7oq1uyF-3viWoEdb4wF3JgWX-EXzDl7UHa6ZK_EzI="
                        alt=""
                      />
                    </label>
                  )}
              ...
              <button onClick={onAddClick} className="bg-blue-500">
                {" "}
                add
              </button>
            </div>
      ...
      {bookStatusFlag && <div>status</div>}
      {purchaseFlag && <div>purch</div>}
      {/* <Footer /> */}
    </div>
  );
};
